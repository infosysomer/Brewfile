...
######################################################################
# 🍺 InfosysOmer/Brewfile - All-in-one install script                    #
######################################################################
...
# Licensed under MIT (C) Alicia Sykes 2022 <https://www.mohammedomer.com> #
######################################################################
...
show_intro () {
  echo -e "\n${QUESTION_COLOR}🍺 InfosysOmer/Brewfile - Installation Script${RESET}"
